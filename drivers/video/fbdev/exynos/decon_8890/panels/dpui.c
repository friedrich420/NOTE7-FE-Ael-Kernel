...
static const char * const dpui_key_name[] = {
	...
	[DPUI_KEY_PNPOCT] = "PNPOCT",	/* panel POC try count */
	[DPUI_KEY_PNPOCF] = "PNPOCF",	/* panel POC fail count */
#endif
};
...
static struct dpui_info dpui = {
	...
	.field = {
		...
		/* poc parameter */		
#ifdef CONFIG_SUPPORT_POC_FLASH
		DPUI_FIELD_INIT(DPUI_LOG_LEVEL_INFO, DPUI_TYPE_PANEL, DPUI_KEY_PNPOCT),
		DPUI_FIELD_INIT(DPUI_LOG_LEVEL_INFO, DPUI_TYPE_PANEL, DPUI_KEY_PNPOCF),	
#endif
	},
};
