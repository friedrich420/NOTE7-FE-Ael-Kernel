...
hero2lte)
	case $VARIANT in
	xx|duos)
		DTSFILES="exynos8890-gracelte_eur_open_00 exynos8890-gracelte_kor_all_01
			  exynos8890-gracelte_kor_all_02 exynos8890-gracelte_kor_all_03 
			  exynos8890-gracelte_kor_all_05 exynos8890-gracelte_kor_all_07
			  exynos8890-gracelte_kor_all_09 exynos8890-gracelte_kor_all__11"
		;;
	*)
